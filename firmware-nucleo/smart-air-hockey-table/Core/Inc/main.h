...
#define LDR1_IN_Pin LL_GPIO_PIN_6
#define LDR1_IN_GPIO_Port GPIOE
...
#define LDR2_IN_Pin LL_GPIO_PIN_13
#define LDR2_IN_GPIO_Port GPIOF
#define LDR3_IN_Pin LL_GPIO_PIN_14
#define LDR3_IN_GPIO_Port GPIOF
#define LDR4_IN_Pin LL_GPIO_PIN_15
#define LDR4_IN_GPIO_Port GPIOF
